...
As listas em Python são representadasa por colchetes: []
...
if [8, 3, 1] in lista1:
    ...
    print('Não enocntrei a lista')

lista1.extend([123, 44, 67])  # Coloca cada elemento da lista como valor adicional à lista
print(lista1)

# Podemos inserir um novo elemento na lista informando a posição do índice
# OBS: Não substitui o valor inicial. O mesmo será deslocado para a direita.
...
# Podemos facilmenter inverter uma lista
...
# OBS: O pop não somente remove o último elemento mas também o retornar
print(lista5)
lista5.pop()
print(lista5)
...
# Podemos remover toodos os elementos. Ou seja, zerar a lista
...
lista6 = ['Programção', 'em', 'Python:', 'Essencial']
print(lista6)

# Abaixo foi dito: Pegue a lista6, coloque espaço entre cada elemento e transforme em uma string
curso = ' '.join(lista6)
print(curso)
...
# Podemos realmente colocar qualquer tipo de dado em uma lista, inclusive misturar esses dados

lista6 = [1, 2, 3, True, 'Lucas', 'd', [1, 2, 3], 45345345345]
print(lista6)
print(type(lista6))
...
# Utilizaando variáevis em listas
numeros = [1, 2, 3, 4, 5]
print(numeros)
...
# Fazemos acesso aos elementos de forma indexada em listas
#           0        1         2         3
...
# print(num.index(19))  # Gera ValueError
...
print(num.index(5, 1))  # Buscando a partir do indice 1
print(num.index(5, 2))  # Buscando a partir do indice 2
print(num.index(5, 3))  # Buscando a partir do indice 3

# Podemos fazer buscar dentro de um range, inicio/fim
print(num.index(8, 3, 6))  # Buscar o indice de valor 8, entre os indices 3 e 6
...
print(lista[::-1])  # Começa em 0 e vai até o começo de -1 em -1
...
# Veja que ao utilizarmo lista.copy() copiamos os dados de uma lista para uma
# nova lista, mas elas ficaram totalmente independentes, ou seja, modificando
# uma lista, não afeta a outra. Isso em python se chama Deep Copy (cópia profunda)
...
# Veja que utilizamos a cópia via atribuição e copiamos os dados da lista para a
# nova lista mas após realizar modificações em uma das listas, essa modificação
# se refletiu em ambas as listas. Isso em Python é chamado de Shallow Copy.
